...
//             <input type='password' placeholder='Enter Password' className='w-full input input-bordered h-10'/>
//           </div>
//           <a href='#' className='textsm hover:underline hover:text-green-600 mt-2 inline-block'>{"Don't"} have an account?</a>

//           <div>
//             <button className='btn btn-block btn-sm mt-2 bg-green-900 hover:bg-green-700'>Login</button>
//           </div>
